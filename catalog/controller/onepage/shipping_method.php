...
class ControllerOnePageShippingMethod extends Controller {
  	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/onepage/shipping_method.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/onepage/shipping_method.tpl';
		} else {
			$this->template = 'default/template/onepage/shipping_method.tpl';
		}
