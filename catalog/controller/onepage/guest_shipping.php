<?php 
class ControllerOnePageGuestShipping extends Controller {
  	public function index() {	
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/onepage/guest_shipping.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/onepage/guest_shipping.tpl';
		} else {
			$this->template = 'default/template/onepage/guest_shipping.tpl';
		}		
	...
	public function validate() {
		...
		if (!$json) {
			...
			$this->session->data['guest']['shipping_address'] = false; //ADD
