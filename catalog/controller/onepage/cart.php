<?php 
class ControllerOnePageCart extends Controller {
	private $error = array();
	
	public function index() {
		$this->language->load('onepage/cart');
		...
		if (!empty($this->request->post['quantity'])) {
			...
			$this->redirect($this->url->link('onepage/cart'));  			
		}
		...
		$this->document->addStyle('catalog/view/javascript/jquery/colorbox/colorbox.css');
      	...
      	$this->data['breadcrumbs'][] = array(
        	'href'      => $this->url->link('onepage/cart'),
    	...
    	if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			$this->data['action'] = $this->url->link('onepage/cart');   
			...
			$products = $this->cart->getProducts();
      		...
      		foreach ($products as $product) {
        		...
        		$this->data['products'][] = array(
					...
					'remove'   => $this->url->link('onepage/cart', 'remove=' . $product['key'])
				);
      		}
			...
			if (!empty($this->session->data['vouchers'])) {
				foreach ($this->session->data['vouchers'] as $key => $voucher) {
					$this->data['vouchers'][] = array(
						...
						'remove'      => $this->url->link('onepage/cart', 'remove=' . $key)   
					);
				}
			}
			...
			$this->data['checkout'] = $this->url->link('onepage/checkout', '', 'SSL');

			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/onepage/cart.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/onepage/cart.tpl';
			} else {
				$this->template = 'default/template/onepage/cart.tpl';
			}
	...
	public function add() {
		...
		if ($product_info) {			
			...
			if (!$json) {
				...
				$json['success'] = sprintf($this->language->get('text_success'), $this->url->link('product/product', 'product_id=' . $this->request->post['product_id']), $product_info['name'], $this->url->link('onepage/cart'));
