<?php 
class ControllerOnePagePaymentAddress extends Controller {
	public function index() {
		...
		$this->data['entry_same_address'] = $this->language->get('entry_shipping');
		...
		$this->load->model('account/address'); //MOVED FROM LINE 55
		...
		if (isset($this->session->data['payment_address_id'])) {
			...
			if ($this->data['address_id']) {
				...
				$address_info = $this->model_account_address->getAddress($this->data['address_id']);
		...
		var_dump($this->data['addresses']);exit;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/onepage/payment_address.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/onepage/payment_address.tpl';
		} else {
			$this->template = 'default/template/onepage/payment_address.tpl';
		}
