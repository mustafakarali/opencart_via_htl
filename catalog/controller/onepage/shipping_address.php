<?php 
class ControllerOnePageShippingAddress extends Controller {
	public function index() {
		...
		$this->load->model('account/address'); //MOVED FROM LINE 39
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/onepage/shipping_address.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/onepage/shipping_address.tpl';
		} else {
			$this->template = 'default/template/onepage/shipping_address.tpl';
		}
