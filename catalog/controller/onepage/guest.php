<?php 
class ControllerOnePageGuest extends Controller {
  	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/onepage/guest.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/onepage/guest.tpl';
		} else {
			$this->template = 'default/template/onepage/guest.tpl';
		}
