...
<?php } ?>
  ...
  <label for="register"><?php echo $entry_register; ?></label>
  <br />
  <div id="register-area" style="display:none;"></div>
  <br />
</div>
<div class="buttons">
  <div class="left">
...
$('#register-area').load('index.php?route=onepage/register');
$('#register').live('click', function(){
  var ori_text = '<?php echo $button_save; ?>';
  if ($(this).attr('checked')) {
    $('#register-area').slideDown();
    $('#button-payment-address-save').val(ori_text+' & Create Account');
  }else{
    $('#register-area').slideUp();
    $('#button-payment-address-save').val(ori_text);
  };
});
load_payment_method();
//--></script>