...
<div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
  ...
  <div class="buttons">
    <div class="left">
      <input type="button" value="<?php echo $button_save; ?>" id="button-shipping-address-save" class="button" />
    </div>
    <div class="right">
      <input type="button" value="<?php echo $button_reset; ?>" id="button-shipping-address-reset" class="button" />
    </div>
  </div>
</div>
<br />
